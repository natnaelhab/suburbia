...
function Scene({
  ...
  const [showHostspot, setShowHotspot] = useState({
    front: true,
    middle: true,
    back: true,
  });
  ...
  function allie(board: THREE.Group) {
    jumpBoard(board);
    gsap
      .timeline()
      .to(board.rotation, {
      ...
      <group ref={originRef}>
        <group ref={containerRef} position={[-0.25, 0, -0.635]}>
          <group position={[0, -0.086, 0.635]}>
            ...
            />
            <HotSpot
              isVisible={!animating && showHostspot.front}
              position={[0, 0.38, 1]}
              color="#B8FC39"
            />
            ...
            <HotSpot
              isVisible={!animating && showHostspot.middle}
              position={[0, 0.33, 0]}
              color="#FF7A51"
            />
            ...
            <HotSpot
              isVisible={!animating && showHostspot.back}
              position={[0, 0.35, -0.9]}
              color="#46ACFA"
            />
