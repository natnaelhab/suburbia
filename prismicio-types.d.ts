 ...
 */
export interface ThemeGridSliceDefaultPrimary {
  /**
   * Heading field in *TeamGrid → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: theme_grid.default.primary.heading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  heading: prismic.RichTextField;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ThemeGridSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ThemeGridSliceDefaultPrimary>,
  never
>;
 ...
 */
type ThemeGridSliceVariation = ThemeGridSliceDefault;

/**
 * TeamGrid Shared Slice
 *
 * - **API ID**: `theme_grid`
 * - **Description**: ThemeGrid
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ThemeGridSlice = prismic.SharedSlice<
  "theme_grid",
  ThemeGridSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TextAndImageSliceImageOnLeft,
      ThemeGridSlice,
      ThemeGridSliceDefaultPrimary,
      ThemeGridSliceVariation,
      ThemeGridSliceDefault,
      VideoBlockSlice,
